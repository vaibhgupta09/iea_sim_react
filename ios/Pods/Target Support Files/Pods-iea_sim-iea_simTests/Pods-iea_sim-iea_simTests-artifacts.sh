...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/OpenSSL-Universal/Frameworks/OpenSSL.xcframework" "" "true" "ios-arm64_i386_x86_64-simulator/OpenSSL.framework" "ios-arm64_x86_64-maccatalyst/OpenSSL.framework"
  install_xcframework "${PODS_ROOT}/OpenSSL-Universal/Frameworks/OpenSSL.xcframework" "" "false" "ios-arm64_arm64e_armv7_armv7s/OpenSSL.framework"
fi
